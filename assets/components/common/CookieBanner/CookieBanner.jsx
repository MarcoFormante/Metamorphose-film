  ...
  return (
    <div className='cookie-banner'>
        <div className='cookie-banner__container'>
            ...
            <p className='cookie-banner__text'>En continuant à naviguer sur ce site, vous acceptez l'utilisation de cookies pour vous offrir une expérience de navigation optimale.</p>
